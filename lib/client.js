    ...
    var req = https.request(options, function (res) {
        ...
        if (res.statusCode !== 200) {
            if (res.statusCode === 530) {
                con.error('Server requires a newer client version; sudo npm -g update mole');
            } else if (res.statusCode === 531) {
                con.error('Server saw an unrecognized encryption token. Replace with cleartext or a correct token.');
            }
